 ...
 *****
 *****                  v1.2   (released September 23, 1997)
 *****
		     ...
		     int count)
{
  ...
  // fprintf(stderr, "The following line did not compile - Sebastian\n"); exit(-1);
    exit(-1);
...
#if LINUX_VERSION_CODE >= 0x20100
static int abPoll(struct file *file, poll_table *wait) {
