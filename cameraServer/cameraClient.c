/*
 * $Id: cameraClient.c,v 1.1 2002/09/14 16:37:46 rstone Exp $
 *
 */
#ifndef lint
static char rcsid[] =
...
static int image_subscription_orig_image_xmin = 0;
static int image_subscription_orig_image_ymin = 0;
static int image_subscription_orig_image_xsize = COLS;
static int image_subscription_orig_image_ysize = ROWS;
static int image_subscription_return_image_xsize = COLS;
static int image_subscription_return_image_ysize = ROWS;
...
void
cameraRequestImage( int numGrabber, 
		    int orig_image_xmin,
		    int orig_image_ymin,
...
camera_subscribe()
{
  ...
  if (cameraConnected){
    ...
    subscribe.orig_image_xmin    = image_subscription_orig_image_xmin;
    subscribe.orig_image_ymin    = image_subscription_orig_image_ymin;
    subscribe.orig_image_xsize   = image_subscription_orig_image_xsize;
    subscribe.orig_image_ysize   = image_subscription_orig_image_ysize;
    subscribe.return_image_xsize = image_subscription_return_image_xsize;
    subscribe.return_image_ysize = image_subscription_return_image_ysize;
...
void 
cameraSubscribeImage( int numGrabber, int number, 
		      ...
		      int return_image_xsize, int return_image_ysize)
{
  ...
  image_subscription_orig_image_xmin     = image_xmin;
  image_subscription_orig_image_ymin     = image_ymin;
  image_subscription_orig_image_xsize    = image_xsize;
  image_subscription_orig_image_ysize    = image_ysize;
  image_subscription_return_image_xsize  = return_image_xsize;
  image_subscription_return_image_ysize  = return_image_ysize;
 ...
 * *** empty log message ***
 *
 * Revision 1.18  1998/08/16 19:50:00  thrun
