...
int DISPLAY_LOCAL_MAPVALUES_BUTTON = 0;
int LOCAL_ROBOT_= 0;
int LOCAL_BACKGROUND= 0;
int LOCAL_MAPVALUES= 0;
int QUIT_BUTTON= 0;
int SCRIPT_BUTTON= 0;
int BASE_CONNECTED_BUTTON= 0;
int MAP_CONNECTED_BUTTON= 0;
int REGRESSION= 0;
		    ...
		    ROBOT_SPECIFICATIONS_PTR robot_specifications)
{
  ...
  int test= 0;
  float change_x= 0.0, change_y= 0.0, change_orientation= 0.0;
