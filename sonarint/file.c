...
{
  int i= 0, x= 0, y= 0, index= 0, int_value= 0, int_value1= 0, int_value2= 0;
  float float_value= 0.0;
  FILE *iop;
  int file_ended= 0, error= 0;
  char command[256];
...
int read_script(ROBOT_STATE_PTR    robot_state,
		...
		ROBOT_SPECIFICATIONS_PTR robot_specifications)
{
  int i= 0,j=0, int_value= 0;
  int int_value1 =0, int_value2=0;
  float float_value= 0.0, float_value1= 0.0, float_value2= 0.0, float_value3= 0.0;
  int file_ended= 0, error= 0;
  char command[256];
  ...
  int print_flag = 0;
  int done_for_now= 0;
  long int sleep_duration= 0;
  float velocity= 0.0, velocity2= 0.0; 
  int new_format = 0;
